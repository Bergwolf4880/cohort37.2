...
const updateList = (array) => {                                     //параметром (array) является наш массив
    ...
    const temp = array.map(element => {                                          //и содержимое цикла отвечает за создание списка с нуля
        ...
        return newListItem;                                                                //добавляем новый элемент в лист
    });
    listAllElements.append(...temp);
};

...
const playersBackup = [...players];

const goals = playersBackup.map(el => el['goals'] = Math.round(Math.random() * 20));

//console.log(goals);
console.log(playersBackup);

// Отфильтровать и вывести в консоль всех игроков, у которых рост выше или равен 180 и вес ниже 80.

const heightWeight = playersBackup.filter((player) => player.height > 180 && player.weight<80);

//console.log(heightWeight);

// Отсортировать игроков по количеству забитых голов.

const goalsScored = playersBackup.sort((player1, player2) => player1.goals - player2.goals);
